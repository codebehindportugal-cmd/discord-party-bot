...
const commands = [
  ...
  ["/iniciar-evento", "Cria canal de voz temporario e comeca o tracking."],
  ["/ver-tempo", "Mostra tabela de tempo por jogador em tempo real."],
  ["/adicionar-loot", "Regista gold ou item obtido durante o evento."],
  ["/confirmar-split", "Fecha o calculo, publica embed e envia DMs."],
  ["/config-canal", "Configura canais de anuncios, eventos e logs."]
];
